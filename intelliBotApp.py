...
def main():
    ...
    st.header(f":speech_balloon: Hello, I am your IntelliHeal Tech AI Assistant. I am happy to assist you with your questions about IT policies and procedures")
